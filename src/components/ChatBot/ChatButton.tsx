  ...
  return (
    ...
    >
      <div className="relative">
        <Avatar className="h-12 w-12 border-2 border-white/20 group-hover:scale-110 transition-transform duration-300">
          <AvatarImage src={krishHeadshot} alt="Chat with Krish" />
